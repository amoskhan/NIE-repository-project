...
public class AgentOrchestrator : IAgentOrchestrator
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var agent = new ChatClientBuilder(_aiService.CreateChatClient())
                ...
                .BuildAIAgent(
                    ...
                    name: "AppTemplateAssistant",
                    description: "App Template assistant with grounded tools.",
                    tools: aiFunctions,
                ...
                cancellationToken: cancellationToken))
            {
                ...
                await writer.WriteAsync(
                    new AIStreamEventDto { Type = "message", Content = update.Text },
                    cancellationToken);
            }
            ...
            {
                await writer.WriteAsync(
                    new AIStreamEventDto { Type = "message", Content = finalText },
                    cancellationToken);
            }
        ...
        catch (Exception ex)
        {
            ...
            await writer.WriteAsync(
                new AIStreamEventDto { Type = "error", Error = "AI service error." },
                cancellationToken);
        }
        finally
        {
