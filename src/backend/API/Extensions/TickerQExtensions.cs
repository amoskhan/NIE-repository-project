        ...
        IHostEnvironment environment)
    {
        ...
        services.AddTickerQ(options =>
        {
            options.ConfigureScheduler(schedulerOptions =>
            {
                ...
                // Cron expressions on [TickerFunction] evaluate against this zone,
                // which is the same "Application:TimeZone" setting DateTimeHelper uses.
                schedulerOptions.SchedulerTimeZone = DateTimeHelper.TimeZone;
            });
