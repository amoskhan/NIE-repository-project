...
//     /<prefix>/@<owner>/<workspace>/apps/preview-main/
...
//
// This block is duplicated (not imported) in ../auth/vite.config.ts, minus the app
...
export default defineConfig({
  ...
  server: {
    ...
    // receives via window.__APP_TEMPLATE_CONFIG__ (…/apps/main-api/…), which the preview
