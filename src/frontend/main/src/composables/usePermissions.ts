...
// Menu items live in src/frontend/main/src/app-config/navigation.ts; access codes,
// role maps, and role labels live in src/frontend/main/src/app-config/accessFunctions.ts.
