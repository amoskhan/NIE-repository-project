...
const STORAGE_KEY_PREFIX = "app-template-notification-preferences";
...
export enum EAdminNotificationSettingKey {
  ...
  MonitoringEnabled = "Notifications.Admin.Monitoring.Enabled",
...
> = {
  ...
  Monitoring: ENotificationPreferenceKey.WorkspaceAnnouncements,
};
...
export const ADMIN_NOTIFICATION_SETTING_DEFINITIONS: AdminNotificationSettingDefinition[] =
  [
    ...
    {
      key: EAdminNotificationSettingKey.MonitoringEnabled,
...
export function isNotificationEnabledForPreferences(
  ...
  return normalized.subscriptions[
    resolveNotificationPreferenceKey(notification)
  ];
}
