        ...
        <tr>
          <th
            ...
            :class="[
              ...
              column.sortable
                ? 'cursor-pointer select-none hover:bg-secondary-100 dark:hover:bg-secondary-700'
                : '',
              column.class,
            ]"
      ...
      >
        ...
        <tr v-if="loading">
          <td :colspan="columns.length" class="px-6 py-12 text-center">
            <div class="flex items-center justify-center gap-2">
              <AppLoaderSymbol size="sm" label="Loading table data" />
        ...
        <tr v-else-if="!data.length">
          <td
            ...
            class="px-6 py-12 text-center text-secondary-500 dark:text-secondary-400"
          >
            {{ emptyMessage }}
          </td>
        </tr>
