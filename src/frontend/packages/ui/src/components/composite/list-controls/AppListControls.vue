...
import { AppSmartFilterDropdown } from "../smart-filter-dropdown";
...
<template>
  ...
  >
    ...
    <div v-if="showMobileToolbar" class="app-list-mobile-toolbar">
      <div class="app-list-mobile-toolbar__inner">
        <button
          v-if="mobileShowBackButton"
          class="app-list-mobile-toolbar__back"
          type="button"
        ...
        <label class="app-list-mobile-toolbar__search">
          <MagnifyingGlassIcon
          ...
          <input
            ...
            :placeholder="searchPlaceholder"
            class="app-list-mobile-toolbar__input"
            type="text"
            @input="
              handleSearchUpdate(
          ...
          <button
            v-if="searchTerm"
            class="app-list-mobile-toolbar__clear"
            type="button"
        ...
        <button
          v-if="showFilterDropdown"
          class="app-list-mobile-toolbar__filter"
          :class="{
            'app-list-mobile-toolbar__filter--active':
        ...
        >
          ...
          <span
            ...
            class="app-list-mobile-toolbar__badge"
          >
            {{ activeFilterCount }}
          </span>
        </button>
...
.app-list-mobile-toolbar__inner {
  display: flex;
  align-items: center;
  gap: 0.65rem;
  pointer-events: auto;
...
.app-list-mobile-toolbar__search {
  display: flex;
  flex: 1 1 auto;
  align-items: center;
  gap: 0.75rem;
...
.app-list-mobile-toolbar__input {
  width: 100%;
  min-width: 0;
  border: none;
...
.app-list-mobile-toolbar__input::placeholder {
  color: var(--color-text-muted);
}

.app-list-mobile-toolbar__back,
.app-list-mobile-toolbar__filter,
.app-list-mobile-toolbar__clear {
  display: inline-flex;
  align-items: center;
...
.app-list-mobile-toolbar__back:hover,
.app-list-mobile-toolbar__filter:hover,
.app-list-mobile-toolbar__clear:hover {
...
.app-list-mobile-toolbar__back:active,
.app-list-mobile-toolbar__filter:active,
.app-list-mobile-toolbar__clear:active {
...
.app-list-mobile-toolbar__badge {
  position: absolute;
  top: -0.18rem;
  right: -0.12rem;
  display: inline-flex;
