...
const wrapperClasses = computed(() => cn("space-y-3", props.class));
...
<template>
  <div :class="wrapperClasses">
    <div class="flex items-center justify-between gap-3">
      <div class="space-y-1">
        <h3
          class="text-sm font-semibold text-secondary-900 dark:text-secondary-50"
        >
          {{ label }}
        </h3>
        <p
    ...
    >
      ...
      <div class="flex flex-col items-center gap-3 text-center">
        ...
        <div class="space-y-2">
          <p
            class="text-sm font-medium text-secondary-900 dark:text-secondary-50"
          >
            {{ hint }}
          </p>
    ...
    <ul v-if="selectedFiles.length" class="space-y-2">
      ...
      >
        <div class="flex min-w-0 items-center gap-3">
          ...
          <div class="min-w-0">
            <p
              class="truncate text-sm font-medium text-secondary-900 dark:text-secondary-50"
            >
              {{ file.name }}
            </p>
            <p class="text-xs text-secondary-500 dark:text-secondary-400">
