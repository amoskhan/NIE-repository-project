...
function handleClickOutside(event: MouseEvent) {
  ...
  if (
    ...
    !target.closest(".app-smart-filter-sheet")
  ) {
    closePanel();
  }
}
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <div
            class="app-smart-filter-sheet relative flex max-h-[84dvh] w-full max-w-md flex-col overflow-hidden rounded-[1.75rem] border border-secondary-200 bg-white shadow-[0_30px_60px_-30px_rgba(15,23,42,0.42),0_18px_30px_-24px_rgba(15,23,42,0.28)] dark:border-secondary-700 dark:bg-secondary-900"
            @click.stop
          >
            <div
