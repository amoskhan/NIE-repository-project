...
- All entities must follow App Template conventions
...
\`\`\`mermaid
erDiagram
%% App Template base entities (always present)
AppUser {
int Id PK
string UserName
string FirstName
...
## App Template Entity Conventions
...
6. **DbContext** registers entities in `MainDbContext`
